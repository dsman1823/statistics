  ...
  var c = MathJax.Extension["CHTML-preview"] = {
    ...
    postFilter: function(g, f) {
      if (!f.math.root.toCommonHTML) {
        ...
        e.Push(["Require", MathJax.Ajax, "[MathJax]/jax/output/CommonHTML/config.js"], ["Require", MathJax.Ajax, "[MathJax]/jax/output/CommonHTML/jax.js"]);
